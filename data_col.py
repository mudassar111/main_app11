...
#-------------------------------------------------------------------------------NavBar-Ends------------------------------------------------------------------------------------------------------------
def app():
    st.title('Welcome to Data Collection Interface')
...
#-------------------------------------------------------------Create_aq-------------------------------------------------------------------------------------------------------------------
        if choice_aq == "Create":
            ...
            with col1:
                ...
                thk_aq = st.number_input('Thickness of the Aquifer[m]', 1.,50.,20.)
            with col2:
                baseflow = st.number_input('Base Flow in x-Direction [m\u00B2/day]:', -10000., 10000.,0.1)
                ref_head = st.number_input('Refernce Head[m]', 1.,20.,9.5)
            with col3:
...
#--------------------------------------------------------------Update_aq--------------------------------------------------------------------------------------------------------------------                    
            ...
            if selected_result_aq:
                ...
                with col1:
                    ...
                    new_thk_aq = st.number_input("Thickness of the Aquifer [m]:",1.,50., float(thk_aq))
                with col2:
                    new_baseflow = st.number_input("Base Flow [m\u00B2/day]:",1.,10., float(baseflow))
                    new_ref_head = st.number_input("Refernce Head [m]:", 1., 50., float(ref_head))
                with col3:
...
#----------------------------------------------------------------------Create_Well----------------------------------------------------------------------------------------                   
        if choice_well == "Create":
            ...
            with col1:
                ...
                pump_rate = st.number_input("Pumping / Recharge Rate in [m\u00B3/day]:",-1000.,1000.,1.,0.1)
            with col2:
...
#---------------------------------------------------------------------Update_Well--------------------------------------------------------------------------------
            ...
            if selected_result:
                ...
                with col1:
                    ...
                    new_pump_rate = st.number_input("Pumping / Recharge Rate in [m\u00B3/day]:", -1000., 1000., float(pump_rate))
                with col2:
